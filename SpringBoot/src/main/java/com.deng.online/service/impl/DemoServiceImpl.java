package com.deng.online.service.impl;
...
import com.deng.online.repository.redis.RedisKey;
...
public class DemoServiceImpl implements DemoService{
    ...
    public void updateDemoCache(){
        ...
        //将数据放入缓存中
        redisRepository.set(RedisKey.DEMO_KEY, data);
    ...
    public void sendMessage(String topic, String data) {
        kafkaRepository.sendMessage(topic, data);
    }

    @Override
    public DemoVo findById(String id) {
        DemoBean demoBean = demoSearchRepository.findById(Long.parseLong(id));
        DemoVo vo = new DemoVo();
        if (demoBean != null){
            vo.setId(demoBean.getId());
            vo.setPropertiesOne(demoBean.getPropertiesOne());
    ...
    private List<DemoBean> getDemoList(){
        ...
        String jsonData = redisRepository.get(RedisKey.DEMO_KEY);
